...
class FinishedQuizPage extends StatelessWidget {
  ...
  FinishedQuizPage({Key? key, required this.questions, required this.answers}) : super(key: key) {}
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle trailingStyle =
        TextStyle(color: Theme.of(context).primaryColor, fontSize: 20.0, fontWeight: FontWeight.bold);

    return Scaffold(
      appBar: AppBar(
        iconTheme: IconThemeData(color: Colors.black),
        backgroundColor: Colors.transparent,
        title: Text('Результат тестирования', style: TextStyle(color: Colors.black)),
        elevation: 0,
      ),
      body: Container(
            ...
            children: <Widget>[
              Card(
                ...
                child: ListTile(
                  ...
                  title: Text("Всего вопросов", style: titleStyle),
              ...
              Card(
                ...
                child: ListTile(
                  contentPadding: const EdgeInsets.all(16.0),
                  title: Text("Счет", style: titleStyle),
              ...
              Card(
                ...
                child: ListTile(
                  contentPadding: const EdgeInsets.all(16.0),
                  title: Text("Правильных ответов", style: titleStyle),
              ...
              Card(
                ...
                child: ListTile(
                  contentPadding: const EdgeInsets.all(16.0),
                  title: Text("Неправильных ответов", style: titleStyle),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  RaisedButton(
                    ...
                    color: Theme.of(context).accentColor.withOpacity(0.8),
                    child: Text("Детали", style: TextStyle(color: Colors.white)),
                    onPressed: () {
                  ...
                  RaisedButton(
                    ...
                    child: Text("Перейти к симуляции", style: TextStyle(color: Colors.white)),
                    onPressed: () => Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => SimulationPage(),
                      ),
                    ),
                  ),
                ],
